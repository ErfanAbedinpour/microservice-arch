...
sequenceDiagram
    ...
    GW->>Pay: mTLS
    Pay->>Pay: Validate mTLS identity

    Pay->>Ledger: mTLS
    Ledger->>Ledger: Validate service identity
...
- The receiving service validates the mTLS identity. [docs.cidaas](https://docs.cidaas.com/guides/authentication-authorisation/oauth2/oauth2Flows/tokenexchange/)
...
- Receiver validates mTLS identity.
